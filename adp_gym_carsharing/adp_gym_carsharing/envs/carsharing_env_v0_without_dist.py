...
#    epsSupH_def=-epsSupL_def
    ...
    def __init__(self, num_stations=N_def, num_cars=MAX_CARS_def, aa_min_price=aa_pmin_def, aa_max_price=aa_pmax_def,ab_min_price=ab_pmin_def, ab_max_price=ab_pmax_def, aa=aa_def, ab=ab_def,bb=bb_def, ba=ba_def, discount_rate=discount_rate_def, num_stages=num_stages_def, aa_epsSupL=aa_epsSupL_def,aa_epsSupH=aa_epsSupH_def,ab_epsSupL=ab_epsSupL_def,ab_epsSupH=ab_epsSupH_def):
